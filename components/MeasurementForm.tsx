  ...
  return (
      <div className="mb-4">
          <div className="flex items-center mb-1">
              <div className="bg-gray-200 text-gray-700 font-bold text-sm rounded-md px-3 py-1 mr-3">{id}</div>
              <div>
                  <label htmlFor={id} className="block text-sm font-bold text-gray-700">{measurement.name}</label>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="hidden md:block">
           ...
           <div className="flex justify-center items-center">
             <img src={model.diagram} alt="Diagrama de medição" className="max-w-full h-auto rounded-lg"/>
           </div>
        </div>
      </div>
    </div>
