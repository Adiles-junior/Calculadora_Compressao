...
export const PRODUCTS: ProductModel[] = [
    ...
    { id: 'AD', name: 'AD', description: 'Panturrilha', category: ProductCategory.COMPRESSION_STOCKINGS, image: '/img/MEIAS E BRAÇADEIRAS COMPRESSIVAS/INDIVIDUAL/AD.png', diagram: '/img/MEIAS E BRAÇADEIRAS COMPRESSIVAS/INDIVIDUAL/MEDIÇÃO - INFERIOR.png', requiredMeasurements: ['AD', 'cD', 'cC', 'cB'], specialInputs: ['SHOE_SIZE'] },
    ...
    { id: 'BH', name: 'BH', description: 'Braçadeira até o punho', category: ProductCategory.COMPRESSION_STOCKINGS, image: '/img/MEIAS E BRAÇADEIRAS COMPRESSIVAS/INDIVIDUAL/BH.png', diagram: '/img/MEIAS E BRAÇADEIRAS COMPRESSIVAS/INDIVIDUAL/MEDIÇÃO - INFERIOR.png', requiredMeasurements: ['BH', 'cF', 'cD', 'cB'] },
    { id: 'ZH', name: 'ZH', description: 'Braçadeira até o metacarpo com polegar', category: ProductCategory.COMPRESSION_STOCKINGS, image: '/img/MEIAS E BRAÇADEIRAS COMPRESSIVAS/INDIVIDUAL/ZH.png', diagram: '/img/MEIAS E BRAÇADEIRAS COMPRESSIVAS/INDIVIDUAL/MEDIÇÃO - INFERIOR.png', requiredMeasurements: ['ZH', 'cF', 'cD', 'cB'] },
...
const checkRange = (value: number | undefined, min: number, max: number) => value !== undefined && value >= min && value <= max;
...
export const findSizeForModel = (modelId: string, measurements: MeasurementValues): SizingResult[] => {
    ...
    let results: (SizingResult | null | SizingResult[])[] = [];
    ...
    const uniqueResults = flattenedResults.filter((result, index, self) =>
        index === self.findIndex((r) => (
            r.productLine === result.productLine && r.size === result.size && r.length === result.length
        ))
    );
